class Conversation < ActiveRecord::Base
  ...
  scope :between, -> (sender_id,recipient_id) do
    ...
    where("(conversations.sender_id = ? AND conversations.recipient_id =?) OR (conversations.sender_id = ? AND conversations.recipient_id =?)", {sender_id: params[:sender_id], recipient_id: params[:recipient_id]})
  end
end